...
- 偏好：明确表达的喜好或厌恶
- 健康：身体状况、过敏史、饮食禁忌
- 事件：与 晏林斯的重要互动、约定、里程碑
- 关系：家人、朋友、重要同事
- 价值观：表达的信念或长期目标
- 情感：重要的情感时刻或关系里程碑
- 生活：洛衍当天的活动、饮食、出行、日常经历等生活细节

# 不要提取
- 日常寒暄（"你好""在吗"）
- 晏林斯助手自己的回复内容
- 关于记忆系统本身的讨论（"某条记忆没有被记录""记忆遗漏""没有被提取"等）
- 技术调试、bug修复的过程性讨论（除非涉及洛衍技能或项目里程碑）
-  晏林斯的思考过程、思维链内容
...
- 新信息必须与已知信息逐条比对
- 相同、相似或语义重复的信息必须忽略（例如已知"洛衍去妈妈家吃团年饭"，就不要再提取"洛衍春节去了妈妈家"）
- 已知信息的补充或更新可以提取（例如已知"洛衍养了一只猫"，新信息"猫最近生病了"可以提取）
